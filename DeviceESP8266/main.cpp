...
const char ssid[] = "MAXELL_2.4_F2F"; // SSID del WiFi de pruebas
// Contraseña de la red WiFi
const char pass[] = "a1b2c3d4"; // Contraseña del WiFi de pruebas

//Conexión a Mosquitto
#define USER "user1" // Usuario no administrador creado en la configuracion del broker.
const char MQTT_HOST[] = "brokermqtt.ddnsfree.com"; // IP del broker MQTT configurado, se utiliza el servicio de no-ip para obtener la IP usando un dominio.
const int MQTT_PORT = 8082; // Puerto del broker MQTT configurado. Por defecto es 1883, pero se cambió por 8082.
const char MQTT_USER[] = USER;
const char MQTT_PASS[] = "123456"; // Contraseña del usuario no administrador creado en la configuracion del broker.

//Tópico al que se recibirán los datos
// El tópico de publicación debe tener estructura: <país>/<estado>/<ciudad>/<usuario>/out
const char MQTT_TOPIC_PUB[] = "colombia/valle/tulua/" USER "/out"; //TODO Reemplace el valor por el tópico de publicación que le corresponde.
// El tópico de suscripción debe tener estructura: <país>/<estado>/<ciudad>/<usuario>/in
const char MQTT_TOPIC_SUB[] = "colombia/valle/tulua/" USER "/in"; //TODO Reemplace el valor por el tópico de suscripción que le corresponde.
...
String checkAlert() {
  ...
  Serial.println(String("Mensaje recibido:")+message);
  return message;
}
